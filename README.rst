...
.. image:: https://travis-ci.org/matloob-altaf/ckanext-example_theme.svg?branch=master
    :target: https://travis-ci.org/matloob-altaf/ckanext-example_theme

.. image:: https://coveralls.io/repos/matloob-altaf/ckanext-example_theme/badge.svg
  :target: https://coveralls.io/r/matloob-altaf/ckanext-example_theme
...
do::
    ...
    git clone https://github.com/matloob-altaf/ckanext-example_theme.git
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.example_theme --cover-inclusive --cover-erase --cover-tests


---------------------------------
Registering ckanext-example_theme on PyPI
---------------------------------

ckanext-example_theme should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-example_theme. If that link doesn't work, then
...
ckanext-example_theme is availabe on PyPI as https://pypi.python.org/pypi/ckanext-example_theme.
